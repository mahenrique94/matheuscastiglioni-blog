/* PrismJS 1.15.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+c+csharp+bash+cpp+clojure+ruby+css-extras+docker+elixir+elm+markup-templating+git+go+graphql+less+haskell+http+java+json+kotlin+markdown+lua+nginx+php+php-extras+sql+properties+scss+python+jsx+typescript+reason+sass+stylus+scala+plsql+pug+yaml+toml+tsx&plugins=toolbar+normalize-whitespace+show-language+copy-to-clipboard */
